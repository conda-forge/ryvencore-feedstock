...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ryvencore-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15116&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ryvencore-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ryvencore` can be installed with:

```
conda install ryvencore
```

It is possible to list all of the versions of `ryvencore` available on your platform with:
